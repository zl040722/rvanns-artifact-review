...
This artifact includes the optimized implementation, patches, and test programs used for evaluation. The SLOC counting policy uses `cloc` v2.06, excludes third-party code under `thirdparty/`, and counts nonblank, non-comment source lines across the released artifact. Under this policy, the artifact contains 59,245 SLOC across 273 `cloc`-recognized files: 55,620 lines of implementation, testing, evaluation, and patch artifact code, and 3,625 lines of build, configuration, CI, scripts, and artifact metadata.
